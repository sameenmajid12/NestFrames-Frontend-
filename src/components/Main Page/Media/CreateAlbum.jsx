...
function CreateAlbum({ setVisibility }) {
  ...
  const [albumFriends, setAlbumFriends] = useState([]);
    ...
    <div className="create-album-page">
      <div className="create-album-container">
        ...
        <div className="create-album-body">
          ...
          />
          <div onClick={handleTags} className="create-album-tag-container">
            {albumFriends.length == 0 ? (
              <>
              ...
              <p>
                {albumFriends.map((friend,index) => {
                  if(index===albumFriends.length-1){
          ...
          <div className="create-album-photos-container">
            ...
            {photoUrls.length > 3 &&
            albumPhotoClickerCount < photoUrls.length - 3 ? (
              <div
                onClick={iterateToNextPhoto}
            ...
            {albumPhotoClickerCount > 0 ? (
              <div
                onClick={iterationToPreviousPhoto}
          ...
          <button onClick={createAlbum} className="create-album-button">
            Create
          </button>
        </div>
      </div>
